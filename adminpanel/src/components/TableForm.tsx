...
function TableForm() {
  ...
  return (
    <div className="fixed h-[100vh] w-[100vw] bg-gray-400 flex items-center px-80">
      <div className="w-[450px] pb-4 rounded-md bg-white px-10">
        ...
        >
          ...
          <button
            className=" mt-4 bg-cyan-600 py-1 rounded-md text-gray-200   "
            type="submit"
          >
            Submit
          </button>
